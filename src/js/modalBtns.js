...
// Не знаю як цю функцію назвати, але коли модалка з фільмом показується, цю функцію треба викликати,передаючи в неї один фільм, воно знайде кнопки і повісить усі прослуховувачи.Тепер по кліку на кнопки, воно буде додавати і видаляти фільм з локал стораджа.
